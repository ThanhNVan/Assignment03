...
{
    #region [ CTor ]
    public CategoryDataProviders(ILogger<BaseDataProvider<Category, AppDbContext>> logger, IDbContextFactory<AppDbContext> dbContextFactory) : base(logger, dbContextFactory) {
    }
    #endregion
}
